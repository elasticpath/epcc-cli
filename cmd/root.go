...
func init() {
	...
	rootCmd.PersistentFlags().StringSliceVarP(&globals.RawHeaders, "header", "H", []string{}, "Extra header to include in the request when sending HTTP to a server. You may specify any number of extra headers.")
}
